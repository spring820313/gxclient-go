...
func (caller *HttpTransport) Call(api caller.APIID, method string, args []interface{}, reply interface{}) error {
	// increase request id
...
func (caller *HttpTransport) SetCallback(api caller.APIID, method string, notice func(args json.RawMessage)) error {
	return nil
}
