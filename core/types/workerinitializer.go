...
func (p RefundWorkerInitializer) MarshalTransaction(enc *transaction.Encoder) error {
...
func (p VestingBalanceWorkerInitializer) MarshalTransaction(enc *transaction.Encoder) error {
...
func (p BurnWorkerInitializer) MarshalTransaction(enc *transaction.Encoder) error {
...
func (p WorkerInitializer) MarshalTransaction(enc *transaction.Encoder) error {
	switch p.Type {
